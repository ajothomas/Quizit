...
class MCQ_Question(models.Model):
	...
	choiceA = models.CharField(max_length=1000,default ='')
	choiceB = models.CharField(max_length=1000,default ='')
	choiceC = models.CharField(max_length=1000,default ='')
	choiceD = models.CharField(max_length=1000,default ='')
	choiceE = models.CharField(max_length=1000,default ='')
	choiceF = models.CharField(max_length=1000,default ='')
